...
//         const postulationsResponse = await axios.get(`http://localhost:5000/api/postulaciones/proyecto/${id}`);
...
//     try {
//       await axios.put(
//         'http://localhost:5000/api/postulaciones/actualizar-estado',
//         {
...
//           )}
//           <p className="mb-2"><strong>NUMERO DE VOLUNTARIOS MAXIMOS:</strong> {project.volunteersRequired}</p>
...
//                 <p><strong>Descripción:</strong> {selectedUser.description}</p>
