...
//   {
//     id: 1,
//     title: "Reforestación en Amazonas",
//     description: "Reforestación de áreas afectadas por la deforestación en la región de Amazonas.",
//     deadline: "31/12/2024",
//     image: "https://via.placeholder.com/150" // Reemplaza con la URL de la imagen correspondiente
//   },
//   {
//     id: 2,
//     title: "Ayuda Comunitaria",
//     description: "Clasificación y distribución de alimentos en comunidades vulnerables.",
//     deadline: "30/11/2024",
//     image: "https://via.placeholder.com/150" // Reemplaza con la URL de la imagen correspondiente
//   },
//   {
...
//     description: "Construcción de viviendas para familias en situación de vulnerabilidad.",
//     deadline: "15/10/2024",
//     image: "https://via.placeholder.com/150" // Reemplaza con la URL de la imagen correspondiente
//   }
// ];
...
//               <div key={project.id} className="bg-white shadow-md rounded flex">
//                 <img 
//                   src={project.image} 
//                   alt={project.title} 
//                   className="w-1/3 h-auto rounded-l" 
//                 />
//                 <div className="p-6 flex flex-col w-2/3">
//                   <h3 className="text-xl font-bold mb-2">{project.title}</h3>
//                   <p className="mb-4">{project.description}</p>
//                   <p className="mt-auto text-gray-600">Fecha Límite: {project.deadline}</p>
//                   <Link to={`/project/${project.id}`} className="mt-4 bg-blue-500 text-white py-2 px-4 rounded self-start">Ver Detalles</Link>
//                 </div>
//               </div>
//             ))}
//           </section>
...
//                       <Link to={`/project/${project.id}`} className="bg-blue-500 text-white py-1 px-4 rounded">Ver Detalles</Link>
//                     </td>
//                   </tr>
//                 ))}
//               </tbody>
