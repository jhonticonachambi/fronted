...
//             <a href="/recomendaciones" className="flex-grow">Recomendaciones</a>
//           </li>
//           <li className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded-md cursor-pointer">
//             <FaChartBar className="h-6 w-6" />
//             <a href="/reportes-por-proyectos" className="flex-grow">Reportes</a>
//           </li>
//           <li className="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded-md cursor-pointer">
//             <FaClipboardList  className="h-6 w-6" />
//             <a href="/Tareas" className="flex-grow">Tareas</a>
//           </li>
//         </ul>
//       </nav>
